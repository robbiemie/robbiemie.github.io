type HeroLinkIconName = 'start' | 'knowledge' | 'blog' | 'github' | 'health';
...
const iconPathMap: Record<HeroLinkIconName, JSX.Element> = {
  ...
  health: (
    <>
      <path
        d="M10 16.5s-5.6-3.4-5.6-7.7c0-1.7 1.3-3 3-3 1.1 0 2 .6 2.6 1.5.6-.9 1.5-1.5 2.6-1.5 1.7 0 3 1.3 3 3 0 4.3-5.6 7.7-5.6 7.7z"
        fill="currentColor"
      />
      <path d="M7.1 9.9h1.7v-1.7h2.4v1.7h1.7v2.3h-1.7v1.7H8.8v-1.7H7.1V9.9z" fill="#ffffff" />
    </>
  )
};
